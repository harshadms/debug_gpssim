...
clean:
	rm -f gpssim.o debug_gpssim *.bin .user-motion-size

time: debug_gpssim
	time ./debug_gpssim -e brdc3540.14n -u circle.csv -b 1
	time ./debug_gpssim -e brdc3540.14n -u circle.csv -b 8
	time ./debug_gpssim -e brdc3540.14n -u circle.csv -b 16
